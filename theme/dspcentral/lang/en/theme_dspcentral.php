<?php
$string['pluginname'] = 'dspCentral';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['choosereadme'] = 'dspCentral is a responsive HTML5, three column theme for Moodle 2.5+ originally created by Richard Bakos of <a href="http://www.resonance-designs.com" target="_blank">Resonance Design</a> for <a href="http://www.dspcentral.info" target="_blank">dspCentral</a>.';

$string['configtitle'] = 'dspCentral';
