...
function dspcentral_process_css($css, $theme) {
    ...
    $css = dspcentral_set_menubackcolor($css, $menubackcolor);
    ...
    $css = dspcentral_set_menuhovercolor($css, $menuhovercolor);
    ...
    $css = dspcentral_set_backimage($css, $backimage);
    ...
    $css = dspcentral_set_backposition($css,$backposition);
    ...
    $css = dspcentral_set_backcolor($css, $backcolor);
    ...
    $css = dspcentral_set_logo($css, $logo);
    ...
    $css = dspcentral_set_customcss($css, $customcss);
    
    return $css;
}

function dspcentral_set_menubackcolor($css, $menubackcolor) {
...
function dspcentral_set_menuhovercolor($css, $menuhovercolor) {
...
function dspcentral_set_backimage($css, $backimage) {
	global $OUTPUT;  
...
function dspcentral_set_backposition($css, $backposition = 'no-repeat', $tag = '[[setting:backposition]]'){
...
function dspcentral_set_backcolor($css, $backcolor) {
...
function dspcentral_set_logo($css, $logo) {
	global $OUTPUT;  
	$tag = '[[setting:logo]]';
	$replacement = $logo;
	$css = str_replace($tag, $replacement, $css);
...
function dspcentral_set_customcss($css, $customcss) {
